...
export default function Contact() {
    ...
    const onSubmit = async (event) => {
        ...
        try {
            const response = await fetch("https://formspree.io/f/xqedalqe", {
                method: "POST",
                body: formData,
                headers: {
            ...
            if (response.ok) {
                ...
                setResult("Oops! There was a problem submitting your form. Please try again.");
            }
        } catch (error) {
    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('./assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
                ...
                <input type="hidden" name="subject" value="Yasiru Manujith - New form Submission" />
